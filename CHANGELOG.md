...
- [**breaking**] Update command ([#131](https://github.com/aliev/baker/pull/131))

### ⚙️ Miscellaneous Tasks

- Update deps ([#127](https://github.com/aliev/baker/pull/127))
- Update minijinja to 2.18 ([#128](https://github.com/aliev/baker/pull/128))
...
- Missing schema in git submodules ([#113](https://github.com/aliev/baker/pull/113))
